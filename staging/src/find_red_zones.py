...
active_contact = utils.track_persons(query_df,output_folder = contact_folder, host_url = HOST_URL, port = PORT)
...
pd.concat([df_patient, df_contact]).to_csv(deliver_folder + '/red_zones.csv', index = False)
